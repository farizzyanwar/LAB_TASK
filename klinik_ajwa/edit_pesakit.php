...
if($_SERVER ['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST['FirstName_P'])) {
        $error[] = mysqli_real_escape_string($connect, trim($_POST['FirstName_P']));
    } else {
    ...
    if (empty($_POST['LastName_P'])) {
        $error[] = mysqli_real_escape_string($connect, trim($_POST['LastName_P']));
    } else {
...
echo '<form action ="edit_pesakit.php" method="post">
    ...
    <input id "FirstName_P" type ="text" name ="FirstName_P" size="30" maxlenght="30" value"'.$row[0].'"></p>

    <p><label class = "label" for="Lastname_P" > Last Name: </label>
    <input id "LastName_P" type ="text" name ="LastName_P" size="30" maxlenght="30" value"'.$row[1].'"></p>

    <p><label class = "label" for="InsuranceNumber" >  Insurance Number: </label>
    <input id "InsuranceNumber" type ="text" name ="InsuranceNumber" size="30" maxlenght="30" value"'.$row[2].'"></p>

    <p><label class = "label" for="Diagnose" > Diagnose: </label>
    <input id "Diagnose" type ="text" name ="Diagnose" size="30" maxlenght="30" value"'.$row[3].'"></p>
