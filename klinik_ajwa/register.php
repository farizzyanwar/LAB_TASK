...
if (empty($_POST['Diagnose'])){
    $error [] = 'You forgot to enter diagnose.';
}
else{
...
//make the query:
$q = "INSERT INTO pesakit (ID_P, FirstName_P, LastName_P, InsuranceNumber, Diagnose) VALUES (' ', '$n', '$l', '$i', '$d')";
$result = @mysqli_query ($connect, $q); //run the query
if ($result){ //if its runs
echo '<h1>Thank you. Patient has been registered.<h1>';
exit();
}else {  //if it did run
//message
